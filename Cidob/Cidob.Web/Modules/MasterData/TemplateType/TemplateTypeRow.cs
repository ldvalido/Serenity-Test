...
namespace Cidob.MasterData.Entities
{
    ...
    [ConnectionKey("Default"), DisplayName("TemplateType"), InstanceName("TemplateType"), TwoLevelCached]
    [ReadPermission("MasterData:TemplateType")]
    [ModifyPermission("MasterData:TemplateType")]
    public sealed class TemplateTypeRow : Row, IIdRow, INameRow
    {
        [DisplayName("Id Template Type"), Identity]
        public Int32? IdTemplateType
        {
            get { return Fields.IdTemplateType[this]; }
            set { Fields.IdTemplateType[this] = value; }
        }
        ...
        {
            get { return Fields.IdTemplateType; }
        }
        ...
        {
            public Int32Field IdTemplateType;
            ...
            public RowFields()
                : base("[dbo].[TemplateType]")
            {
                LocalTextPrefix = "MasterData.TemplateType";
            }
        }
    }
}
